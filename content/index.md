...
# NEW: Put the first publication date in the following line. When updating an existing resource, put the last updated date.
last_updated: 2023-@@-@@   # Put the date of this translation YYYY-MM-DD (with month in the middle) 

# translators:  # remove "# " (the hash sign and the space) from the beginning of this line and the lines below
...
github:
  ...
  # next: /path/to/next/file/ # Do not change this
...
changelog: /@@/changelog/ # Do not change this
# NEW: if don't have a separate acknowledgements page, delete the following line. And delete it in the footer below.
acknowledgements: /@@/acknowledgements/  # Do not change this
...
footer: >
  <p><strong>Date:</strong> Updated @@ Month 2024. First published Month 20@@. CHANGELOG.</p>
  <p><strong>Editors:</strong> @@name, @@name. Contributors: @@name, @@name, and <a href="https://www.w3.org/groups/wg/@@wg/participants">participants of the @@WG</a>. ACKNOWLEDGEMENTS lists contributors and credits.</p>
  <p>Developed by the @@ Working Group (<a href="https://www.w3.org/groups/wg/@@">@@WG</a>). Developed as part of the <a href="https://www.w3.org/WAI/@@/">WAI-@@ project</a>, @@co-funded by the European Commission. Updated as part of the <a href="https://www.w3.org/WAI/@@/">WAI-@@ project</a>, @@co-funded by the European Commission.</p>
